...
const Curriculum = () => {
    return (
        <div className="flex flex-col items-center p-8 max-w-4xl mx-auto">
            <h2 className="text-3xl font-bold mb-6 text-white">Enfoque del Programa</h2>
            ...
            <h2 className="text-3xl font-bold mb-6 text-rose-300">Malla Curricular</h2>
            <p className="text-center mb-6 text-lg text-sky-300">
